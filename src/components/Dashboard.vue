            ...
            <div class="burger-table-row" v-for="burger in burgers" :key="burger.id">
                ...
                <div>
                    <select name="status" class="status" @change="updateOrder($event, burger.id)">
                        ...
                        <option v-for="st in status" :key="st.id" :value="st.tipo" :selected="burger.status == st.tipo">
                            {{st.tipo}}
                        </option>
                    </select>
...
export default {
    ...
    methods:{
        ...
        async updateOrder(event, id){
            ...
            this.msg = "Pedido Nº " + res.id+ " alterado com sucesso. Status atual: " + res.status
